...
$resultQuestion1 = mysql_query("SELECT * FROM poll WHERE question='The Alchemist'");
$num_rowsQuestion1 = mysql_num_rows($resultQuestion1);

$resultQuestion2 = mysql_query("SELECT * FROM poll WHERE question='Murder on the orient express'");
$num_rowsQuestion2 = mysql_num_rows($resultQuestion2);

$resultQuestion3 = mysql_query("SELECT * FROM poll WHERE question='Diary of a young girl'");
$num_rowsQuestion3 = mysql_num_rows($resultQuestion3);

$resultQuestion4 = mysql_query("SELECT * FROM poll WHERE question='Crime and punishment'");
...
<body>
	<fieldset>
		...
		<legend>Result of the opinion poll</legend>
		
		<ul>
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion1 ?></span> votes for "The Alchemist"
				<br />
			...
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion2 ?></span> votes for "Murder on the orient express"
			...
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion3 ?></span> votes for "Diary of a young girl"
			...
			<li>
				<span class="total-votes"><?php echo $num_rowsQuestion4 ?></span> votes for "Crime and punishment"
