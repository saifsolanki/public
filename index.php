...
<fieldset>
	...
	<legend>Which is your favourite book?</legend>
	
	<form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
    
    <label>
    	<input type="radio" name="Poll" value="The Alchemist" id="Poll_0" />
     	The Alchemist
     </label>
     
    <label>
    	<input type="radio" name="Poll" value="Murder on the orient express" id="Poll_1" />
      	Murder on the orient express
    </label>
    
    <label>
    	<input type="radio" name="Poll" value="Diary of a young girl" id="Poll_2" />
		Diary of a young girl
	</label>
	
    <label>
    	<input type="radio" name="Poll" value="Crime and punishment" id="Poll_3" />
